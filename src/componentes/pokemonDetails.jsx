                ...
                <div className="col-md-12 mx-auto col-lg-6 mt-0">
                    <div className='row row-cols-2'>
                        <div className='col-12'>
                            ...
                            {(dados.data.name).charAt(0).toUpperCase() + (dados.data.name).slice(1)}
                            <span className='fs-4 text-muted fw-normal ms-2'>
                                #{(dados.data.id).toString().padStart(3, '0')}
                            </span>
                            </h2>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className='my-1'>{dados.data.types.map(typeInfo => (<span key={typeInfo.type.name} className={`badge fs-6 fw-normal my-1 me-2 ${typeInfo.type.name}`} >{typeInfo.type.name}</span>))}</p>  
                        </div> 
                    </div>
